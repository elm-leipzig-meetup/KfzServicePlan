...
var author$project$Templates$Utils$getKonfigForm = function (model) {
	return _List_fromArray(
		[
			A2(
			elm$html$Html$div,
...
var author$project$Templates$Utils$getPlanDiv = function (model) {
	return _List_fromArray(
		[
			A2(
			elm$html$Html$div,
